    ...
    public class DataBaseInitializerRepository
    {
        ...
        private void FillInvoiceTestingInfo(SQLiteConnection dbConnection)
        {
            ...
            string fillInvoiceTestingInfo =
                $@"BEGIN TRANSACTION;
                    INSERT INTO 'Invoice'
                        Values (1, {DateTime.Now.AddYears(-1).Year}, '2021-04-02', 'ANA', 'Ežio ūkis', '305652600', 'LT 100013527916', 'Europos pr. 1, LT kazkas Kaunas', '58454587', 'Swedbank', 'LT857304444165354444', 
                    ...
                    INSERT INTO 'Invoice'
                        Values (2, {DateTime.Now.Year}, '2021-08-30', 'ANA', 'Ežio ūkis', '305652600', 'LT 100013527916', 'Europos pr. ka, LT 46kk0 Kaunas', '867k3l5l1', 'Swedbank', 'LT85730001lkjh352098', 
                    ...
                    INSERT INTO 'Invoice'
                        Values (3, {DateTime.Now.Year}, '2020-04-02', 'ANA', 'Ežio ūkis', '305652600', 'LT 100013527916', 'Europos pr. 34-47, LT 46370 Kaunas', '8675lll81', 'Swedbank', 'LT8573000101lkjh2098', 
