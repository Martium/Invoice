        ...
        private void FillInvoiceTestingInfo(SQLiteConnection dbConnection)
        {
            for (int i = 0; i < 200; i++)
            {
                ...
                string fillInvoiceTestingInfo =
                    $@"BEGIN TRANSACTION;
                    INSERT INTO 'Invoice'
                        Values (1 + {i}, {DateTime.Now.Year}, '2021-04-02', 'ANA', 'Ežio ūkis', '305652600', 'LT 100013527916', 'Europos pr. 34-47, LT 46370 Kaunas', '867538581', 'Swedbank', 'LT857300010165352098', 
